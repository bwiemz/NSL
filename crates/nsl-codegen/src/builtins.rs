...
const RUNTIME_FUNCTIONS: &[(&str, &[types::Type], Option<types::Type>)] = &[
    ...
    ("nsl_tensor_reduce_to_shape", &[types::I64, types::I64], Some(types::I64)),
    ...
    ("nsl_speculative_decode_step", &[types::I64, types::I64, types::I64, types::I64, types::I64, types::I64, types::I64, types::I64, types::I64], Some(types::I64)),
    ...
    ("nsl_embedding_backward", &[types::I64, types::I64, types::I64], Some(types::I64)),
    ("nsl_cross_entropy_backward", &[types::I64, types::I64, types::I64], Some(types::I64)),
