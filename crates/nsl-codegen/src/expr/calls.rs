...
impl Compiler<'_> {
    pub(crate) fn compile_call(
        ...
        // CSLA tape-carry gate intrinsic: fused-SDPA launch counter
        // (variant 0 = forward, 1 = backward) — lets parity fixtures assert
        // the fused kernel actually fired instead of the decomposed path.
