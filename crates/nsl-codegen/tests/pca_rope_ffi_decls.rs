...
//!   * `nsl_flash_attention_csha_backward`   — 53 params (includes
//!     num_docs_or_zero; per-doc CTA backward landed in Sprint 5)
//!
...
fn csha_backward_decl_has_doc_starts_trailing_param() {
    ...
    // num_docs_or_zero was added in Sprint 5 (per-doc CTA backward).
    assert_eq!(
        sig.params.len(),
        53,
