...
pub fn classify_backward_access(op_name: &str) -> BackwardAccess {
    match op_name {
        ...
        "Add" | "Sub" | "Neg" | "AddScalar" | "MulScalar" | "SumReduce" | "MeanReduce"
        | "Transpose" | "Slice" | "Unsqueeze" | "Expand" => BackwardAccess::ShapeOnly,
        ...
        "Mul" | "Div" | "MatMul" | "ReLU" | "GELU" | "SiLU" | "Log" | "Abs" | "Clamp" | "Exp"
        | "Sqrt" | "Sigmoid" | "Tanh" | "Softmax" | "EmbeddingLookup" | "LayerNorm" | "RMSNorm"
        | "Conv2d" | "BiasAdd" | "Cat" | "Stack" => BackwardAccess::DataRequired,
...
mod tests {
    ...
    fn test_sum_reduce_is_shape_only() {
        assert_eq!(
            classify_backward_access("SumReduce"),
    ...
    fn test_mean_reduce_is_shape_only() {
        assert_eq!(
            classify_backward_access("MeanReduce"),
            BackwardAccess::ShapeOnly
        );
    }
    ...
    fn test_transpose_is_shape_only() {
        assert_eq!(
            classify_backward_access("Transpose"),
            BackwardAccess::ShapeOnly
        );
    }
    ...
    fn test_softmax_is_data_required() {
        assert_eq!(
            classify_backward_access("Softmax"),
            BackwardAccess::DataRequired
        );
    }
    ...
    fn test_bias_add_is_data_required() {
        assert_eq!(
            classify_backward_access("BiasAdd"),
            BackwardAccess::DataRequired
        );
    }
    ...
    fn test_stack_is_data_required() {
        assert_eq!(
            classify_backward_access("Stack"),
            BackwardAccess::DataRequired
        );
    }
    ...
    fn test_reduce_max_is_aux() {
        assert_eq!(
            classify_backward_access("ReduceMax"),
    ...
    fn test_gather_is_aux() {
        assert_eq!(
            classify_backward_access("Gather"),
            BackwardAccess::AuxDataRequired
        );
    }
    ...
    fn test_maxpool_is_aux() {
        assert_eq!(
            classify_backward_access("MaxPool2d"),
            BackwardAccess::AuxDataRequired
        );
    }
    ...
    fn test_unknown_op_conservative() {
        assert_eq!(
            classify_backward_access("FutureOp"),
            BackwardAccess::DataRequired
        );
    }
