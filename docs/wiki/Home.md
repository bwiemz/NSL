...
- Subcommands and flags: [CLI-Reference](CLI-Reference.md) (generated by `nsl doc cli`; the same words as `nsl <command> --help`)
- What `stdlib/` declares: [Stdlib-Reference](Stdlib-Reference.md) (generated by `nsl doc stdlib`; signatures come from the parser)
